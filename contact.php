                ...
                <div class="container-fluid">
                    <a class="navbar-brand" href="index.html">
                        <div class="logo-container d-flex align-items-center">
                            <img src="image/Record-App-Logo-512.png" alt="logo" class="img-fluid" style="height: 50px; margin-right: 10px;">
                            <h4 class="mb-0" style="font-weight: 900;">97.7 Record FM</h4> 
                        </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="about_us.html">News </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="col mb-3">
                        <div class="h-100 d-flex flex-column bg-secondary-color rounded-3 p-5">
                            ...
                            <form class="d-flex flex-column h-100 justify-content-center w-100 needs-validation mb-3 form" novalidate="">
                                <div class="mb-3">
                                    <input type="text" class="form-control py-3 px-4" name="name" id="name" placeholder="Name" required="">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control py-3 px-4" name="subject" id="subject" placeholder="Subject" required="">
                                    <div class="invalid-feedback">
                                        The field is required.
                                    </div>
                                </div>
                            ...
                            <div class="d-flex h-100 flex-column justify-content-center">
                                ...
                                <form class="w-100 form needs-validation">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="email" name="email" class="form-control py-3 px-4 form-white" placeholder="Your Email" aria-label="Recipient's username" aria-describedby="button-addon2" required="">
                                        <button class="btn button btn_submit-subscribe font-1  fw-bold px-5" type="submit" id="button-addon2">Subscribe</button>
                                    </div>
                                </form>
                            </div>
